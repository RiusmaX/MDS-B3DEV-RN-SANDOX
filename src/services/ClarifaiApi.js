      ...
      inputs: [
        {
          data: {
            ...
            text: {
              raw: "For an e-commerce site, I'd like you to describe the product in this image. Your tone should be engaging and commercial. You must respond with an JSON object directly, containing: the product title named “title”, the product description named “description” and 5 keywords associated with the product in an array named “tags”. I need to parse it directly with code. You need to answer in French."
            }
          }
        }
      ]
